"""
Renderizador 3D de Peças de Xadrez
Phong Shading + Rasterização Scan-Line + Backface Culling

CORREÇÕES APLICADAS:
  1. Peça de dama revertida para cilindro baixo simples (peça de jogo de damas)
  2. Todas as peças reescalonadas para que todo vértice fique em |10|
  3. Origem do SCM marcada explicitamente no gráfico 3D
  4. Rasterização trocada de força-bruta para scan-line com par-ímpar
  5. Bug de janelas duplicadas corrigido
  6. Superfície quadrada com espessura adicionada como base da cena
"""
...
_AM = 4.9
_peao_raw   = _normalizar_peca(criar_peao(),   alvo_max=_AM)
...
# ============================================================
# CORREÇÃO 5: RASTERIZAÇÃO EM 3 RESOLUÇÕES (sem janelas duplas)
# ============================================================
...
ent_eye_x, ent_eye_y, ent_eye_z = campo(sb, "👁 Câmera (Eye)", [0, 10, 30])
