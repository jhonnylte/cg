...
def atualizar_grafico():
    ...
    eixo_3d.scatter(ax_at, az_at, ay_at, color='red', s=150, marker='.', label='At (Alvo)')
    eixo_3d.scatter(ex, ez, ey, color='black', s=100, marker='.', label='Eye (Câmera)')
    eixo_3d.scatter(0, 0, 0, color='green', s=100, marker='.', label='Origem (0,0,0)')
